...
const ScheduleHero = () => {
    return (
        <div className='relative w-[360px] h-auto flex flex-row pt-[20px] pb-[32px] pl-[16px] pr-[16px] shadow-md' 
             style={{ background: 'linear-gradient(180deg, #3232DB 0%, #0B0B53 100%)' }}>
            ...
            <Image src="/hospital-bed.png" alt='gambar dokter konsul' width={190.48} height={86.19} className='absolute bottom-0 right-0 z-10' />
        </div>
    );
};
